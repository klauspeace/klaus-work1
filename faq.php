	...
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px;">
				<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center;  background-color: #3c529d; color: white;">FREQUENTLY ASKED QUESTIONS:</div>
				<p><strong>YOU AND MANY OTHERS MAY ASK;</strong></p>
				<p>
					<strong>What is C.Y.F? </strong><br />
					
				</p>
				<p>
					<strong>Can anything good come from the youths?</strong><br />	
					
				
				</p>
				<p>
					<strong>Why should one be concerned about all these activities?:</strong><br />
