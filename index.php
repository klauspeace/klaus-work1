...
<div id="vtHP3_s_head">
	<div class="row">
		<div class="container" style="border-radius:3[0px;">
			<ul class="nav nav-justified">
				<!--li><a href="#vtHP3_s1">Fasting &amp; Prayer</a></li>
				<li><a href="#vtHP3_s2">Good Conduct</a></li>
				<li><a href="#vtHP3_s3">Success</a></li-->
                                <li class="grand_li son"><a href="pccmolyko.php"><?php echo htmlspecialchars($lang['pccmolyko']); ?></a></li>
				...
				<li class="grand_li son"><a href="other_activities.php"> <?php echo htmlspecialchars($lang['other_activities']); ?>
				</a></li>
...
<div class="container" style="margin-top: 15px;">
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="vt_col_4  col-lg-12 col-sm-12">
			<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center; background-color: #3c529d; color: white;"><marquee>WELCOME TO CHRISTIAN YOUTH FELLOWSHIP MOLYKO, INSTRUMENTS OF GOD'S PEACE</marquee></div>
			<div class="row">
				<div class="vt_col_4  col-lg-4 col-sm-4" style="float: left;"><strong>Together...In Fellowship.  In fellowship...With Christ!</strong>
                <img alt="" src="assets/global_assets/images/1.jpg" class="img-responsive" style="max-width:100%; border-radius:50px; background-color:#3c529d; "/>
                </div>
			  <div class="vt_col_4  col-lg-8 col-sm-8" style="text-align: justify">
                ...
                <strong>MICHAEL ASAFOR CHE</strong>
                <p><strong><em>President, CYF Molyko (November 2016 - Date)</em></strong></p>
                <p>&nbsp;</p>
	...
	<?php include 'include/sidebarhome.php';?>	
</div>
</main>
