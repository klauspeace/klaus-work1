	...
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
			<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 18px;">BROTHERS' CORNER</div>
			  

               <strong>Ojectives of the Brothers' Corner:</strong>
              <p>
	
              </p>
			  
			  <strong>Members of the Brothers' Corner:</strong>
              <p>&nbsp;</p>
