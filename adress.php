	...
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
		    <div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center;  background-color: #3c529d; color: white;">CYF MOLYKO CONTACTS AND ADDRESS</div>
		    
             <p><strong>CYF MOLYKO CONTACT: Tel: </strong>(+237) 676340570 / 676410110 / 672487123/650422372 </p>
             <p><strong>E-mail: </strong> / contact@cyfmolyko.net / cyfmolyko@gmail.net</p>
          </div>
		</div>
	</div>
