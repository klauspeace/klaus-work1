...
<div class="container" style="margin-top: 15px;">
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
				<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center;  background-color: #3c529d; color: white;">DISCIPLINARY COMMITTEE</div>
				<br/>
				<P><strong>CYF Molyko has a very compitent and God-chosen Disciplinary Committee</strong></br>
				   This committee is made up of the following <a href = "pgallerydisc.php"><strong><button>members</button></strong></a>
				</p>
	...
	<?php include 'internalrights/internaldisc.php';?>	
</div>
</main>
