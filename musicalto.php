...
<div class="container" style="margin-top: 15px;">
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
				<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center;  background-color: #3c529d; color: white;">ALTO MUSIC PART</div>
				<br/>
				<P>
				CYF Molyko has the following <a href = "pgalleryalt.php"><strong><button>alto singers</button></strong></a>
				</p>
	...
	<?php include 'internalrights/internalalt.php';?>	
</div>
</main>
