	...
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
		    <div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 16px;">SIGN UP</div>
				<style>  
        .login-panel {  
            margin-top: 150px;  
        }
                    ...
                    <div class="panel-body">  
                        <form role="form" method="post" action="registration.php">  
                            <fieldset>  
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="sign up" name="sign up" >  
