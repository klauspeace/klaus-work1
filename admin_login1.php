...
<div class="container" style="margin-top: 15px;">
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
		    <div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 16px;">ADMIN LOGIN</div>
				   <style>  
        .login-panel {  
            margin-top: 150px;  
		}
    ...
    <body>  
	  ...
	  <h3><a href="login1.php"> <button>BACK TO SIGN IN</button></a></h3>
    <div class="container">  
        <div class="row">  
                    ...
                    <div class="panel-body">  
                        <form role="form" method="post" action="admin_login1.php">  
                            <fieldset>  
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="login" name="admin_login1" >  
    ...
    if(isset($_POST['admin_login1']))//this will tell us what to do if some data has been post through form with button.  
    {  
        ...
        {  
            ...
            echo "<script>window.open('view_users1.php','_self')</script>";  
        }  
