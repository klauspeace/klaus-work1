...
<div class="container" style="margin-top: 15px;">
            ...
            <div class="col-md-4 col-md-offset-4">  
                <div class="login-panel panel panel-success">  
                    ...
                    <div class="panel-body">  
                        <form role="form" method="post" action="admin_login_registered.php">  
                            <fieldset>  
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="login" name="admin_login_registered" >  
    ...
    if(isset($_POST['admin_login_registered']))//this will tell us what to do if some data has been post through form with button.  
    {  
        ...
        {  
            ...
            echo "<script>window.open('view_registered.php','_self')</script>";  
        }  
