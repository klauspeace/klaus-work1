...
<div class="container" style="margin-top: 15px;">
            ...
            <div class="col-md-4 col-md-offset-4">  
                <div class="login-panel panel panel-success">  
                    ...
                    <div class="panel-body">  
                        <form role="form" method="post" action="admin_login_members.php">  
                            <fieldset>  
                                ...
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="login" name="admin_login_members" >  
    ...
    if(isset($_POST['admin_login_members']))//this will tell us what to do if some data has been post through form with button.  
    {  
        ...
        {  
            ...
            echo "<script>window.open('view_members.php','_self')</script>";  
        }  
