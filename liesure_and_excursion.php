	...
	<div class="vt_col_4  col-lg-8 col-sm-8">
		<div class="row">
		  <div class="col-md-12" style="padding-bottom: 25px; text-align: justify;">
		    <div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 22px; text-align: center;  background-color: #3c529d; color: white;">LIESURE AND EXCURSIONS</div>
			<p></p>
			<p>&nbsp;</p>
			<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 18px;  background-color: #3c529d; color: white;">LIESURE</div>
			<p></p>
			<p>&nbsp;</p>
			<div class="alert alert-info" role="alert" style="font-weight: bold; font-size: 18px;  background-color: #3c529d; color: white;">EXCURSIONS</div>
			<p></p>
				<p>&nbsp;</p>
